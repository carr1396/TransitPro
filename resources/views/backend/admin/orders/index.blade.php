          ...
          <table class="table table-striped" id="thegrid">
            ...
            <tbody>
              ...
              @foreach($orders as $order)
                ...
                <td><a href="{{route('dashboard.admin.orders.show', $order->id)}}" class="btn btn-success btn-xs"><span class="glyphicon glyphicon-eye-open"></span></a></td>
                <td><a href="{{route('dashboard.admin.orders.edit', $order->id)}}" class="btn btn-primary btn-xs"><span class="glyphicon glyphicon-edit"></span></a></td>
                <td>
                  {!! Form::model($order, ['route' => ['dashboard.admin.orders.destroy', $order->id],
                    'method' => 'DELETE'
                    ]) !!}
